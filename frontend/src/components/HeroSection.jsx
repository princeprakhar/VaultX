    ...
    <div className="bg-gradient-to-r border rounded-xl shadow-xl from-slate-400 to-gray-600 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
          <button onClick={handleSignup} className="bg-white text-purple-500 font-bold py-3 px-6 rounded-full shadow-lg hover:bg-yellow-300 hover:text-purple-700 transition duration-300 flex items-center justify-center">
            Sign Up
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <p className="mb-4">
          VaultX is a cutting-edge finicial .
        </p>
