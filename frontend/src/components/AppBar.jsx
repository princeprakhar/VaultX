...
import { Home, Send, Wallet, User, LogOut, Github } from "lucide-react";
  ...
  return (
    <div className="shadow mt-3 mx-4 rounded-xl h-14 flex justify-between items-center px-4 bg-white">
      ...
      <div className="flex items-center justify-evenly">
        ...
        <div className="bg-gray-200 text-black rounded-full h-10 w-10 ml-3 flex items-center justify-center">
